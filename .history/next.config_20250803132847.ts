      ...
      config.optimization.splitChunks = {
        ...
        cacheGroups: {
          three: {
            ...
            priority: 10, // 🔧 FIX: Снижен с 30 до 10
            reuseExistingChunk: true,
            chunks: 'async', // 🔧 FIX: Только для async imports
          },
          // 🔧 FIX: Убраны AI библиотеки из client bundle
          vendor: {
            name: 'vendor',
            test: /[\\/]node_modules[\\/]/,
            priority: 10,
        ...
        headers: [
          {
            ...
            // 🔧 FIX: Правильный формат для multiple origins
